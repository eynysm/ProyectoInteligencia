namespace WindowsFormsApp1
{
	partial class FrmPrincipal
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Perceptrón Simple";
			// 
			// panel2
			// 
			...
			// button1
			// 
			this.button1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(112)))), ((int)(((byte)(182)))), ((int)(((byte)(32)))));
			...
			this.button1.Text = "Entrenamiento";
